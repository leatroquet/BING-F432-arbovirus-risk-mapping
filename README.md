...
This repository contains the R script and output figures produced for a risk mapping project conducted as part of the course **BIOL-F432 Spatial and Molecular Epidemiology**.
...
- `Output_Rapport_1.docx`: Word document containing the figures generated from the R script.
